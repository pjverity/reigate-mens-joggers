		...
		<security:authorize access="isAuthenticated()">
			<ul class="navbar-nav">
				<li class="nav-item dropdown">
					<a class="nav-link dropdown-toggle" href="<c:url value="/"/>" rel="nofollow" class="dropdown-toggle" data-toggle="dropdown" role="button">
					...
					<div class="dropdown-menu dropdown-menu-right">
						...
						<security:authorize access="hasRole('MEMBER')">
							...
							<form class="form-inline" name="logoutForm" action="<c:url value='/logout'/>" method="post" role="logout">
								<security:csrfInput/>
								<a class="dropdown-item" href="#" rel="nofollow" onclick="document.logoutForm.submit()">Logout</a>
							</form>
						</security:authorize>
					</div>
				</li>
